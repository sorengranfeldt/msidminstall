...
if ($Step1 -or $All)
{
	...
	NET GROUP $Settings.FIAB.SynchronizationService.GroupBrowse $Settings.FIAB.General.ServiceAccounts.FIMService /ADD /DOMAIN
...
if ($Step3 -or $All)
{
	...
	$sid = get-sid $Settings.FIAB.General.ServiceAccounts.FIMService
